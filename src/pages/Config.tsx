...
function ConfigPage() {
  ...
  const handleResetOpenaiApiUrl = (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    ...
    inputRef.value = 'https://api.anthropic.com';
    inputRef.focus();
  ...
  return (
    <div className="p-4 w-[28.75rem] max-w-[100vw] bg-base-100 overflow-y-auto overflow-x-hidden">
      ...
      <form method="post" onSubmit={handleSave}>
        ...
        <div className="mb-2 form-control">
          <label className="label">
            <span className="text-lg font-bold label-text">{t('Claude API Url')}</span>
          ...
          <Input
            ...
            color="primary"
            className="break-all"
            placeholder={t('Plsase input Claude API Url here.')}
        ...
        <div className="mb-2 form-control">
          <label className="label">
            <span className="text-lg font-bold label-text">{t('Claude API Key')}</span>
            <span className="label-text-alt">
              <a
                className="link link-primary"
                href="https://anthropic.com/earlyaccess/"
                target="_blank"
                rel="noreferrer noopener"
              >
                {t('Get your Claude API Key')}
              </a>
            </span>
          </label>
          <textarea
            ...
            placeholder={t('Plsase paste your Claude API Key here.')}

...
const pwaOptions: Partial<VitePWAOptions | ManifestOptions> = {
  ...
  description:
    'A translator app that uses Anthropic Claude to translate between languages. It is a PWA that can be installed on your phone or desktop.',
  manifest: {
    short_name: 'Professional Translator',
